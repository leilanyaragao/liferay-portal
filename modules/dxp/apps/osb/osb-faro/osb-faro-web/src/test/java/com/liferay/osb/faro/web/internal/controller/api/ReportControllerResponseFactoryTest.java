...
public class ReportControllerResponseFactoryTest {
	...
	public void testBuildLastExportResultedAnError() {
		Map<String, Object> responseMap = new HashMap<String, Object>() {
			{
				put("createdDate", "2022-05-01'T'12:00:00.000'Z'");
				put("fromDate", "2022-04-01'T'12:00:00.000'Z'");
				put("previousStatus", "ERROR");
				put("status", "PENDING");
				put("toDate", "2022-04-30'T'12:00:00.000'Z'");
				put("type", "PAGE");
			}
		};
		...
		Map<String, Object> responseMap = new HashMap<String, Object>() {
			{
				put("createdDate", "2022-05-01'T'12:00:00.000'Z'");
				put("fromDate", "2022-04-01'T'12:00:00.000'Z'");
				put("startedDate", "2022-05-02'T'12:00:00.000'Z'");
				put("status", "RUNNING");
				put("toDate", "2022-04-30'T'12:00:00.000'Z'");
				put("type", "PAGE");
			}
